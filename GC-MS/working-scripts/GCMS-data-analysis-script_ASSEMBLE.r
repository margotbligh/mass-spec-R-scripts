...
library(scico)
library(pander)
library(scales)#allows you to show palette with show_col(<palname>)
...
#Margi directories
general_dir <- "/Users/margotbligh/Google_Drive/MPI_Masters/Assemble"
data_dir <- "/Users/margotbligh/Google_Drive/MPI_Masters/Assemble/mzML-files"
