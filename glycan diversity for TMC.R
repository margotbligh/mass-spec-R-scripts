...
png(filename="C:/Users/admin/ownCloud/Deep-water kelp/Presentations/Thesis committee meeting 11May2021/Fig2_oligosaccharides_POS531-2_Ex33b_procA 06May2021.png",
    height = 10, width=8.9, units = "cm", res = 200)
par(mfrow=c(4,1), mai=c(0.2,0.4,0,0.1), omi=c(0.3,0.3,0,0))
plot(dp2, xaxt='n', main=NA, las=2, ylab='', yaxt='n', col="black", border=NA)
